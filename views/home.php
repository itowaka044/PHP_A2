        ...
        <main class="main-content">
            ...
            <section>
                ...
                <div class="navigation-menu">
                    ...
                    <a href="/PHP_A2/reserva/consultar" class="menu-item">
                        <div class="menu-icon">📋</div>
                        <div class="menu-title">Consultar Reservas</div>
                        <div class="menu-description">Veja todas as reservas ativas</div>
                    </a>

                    <a href="/PHP_A2/reserva/consultar-id" class="menu-item">
                        <div class="menu-icon">🔍</div>
                        <div class="menu-title">Buscar por ID</div>
                        <div class="menu-description">Encontre uma reserva específica</div>
                    </a>

                    <a href="/PHP_A2/teste" class="menu-item">
                        <div class="menu-icon">⚙️</div>
                        <div class="menu-title">Área de Testes</div>
                        <div class="menu-description">Acesso ao sistema completo</div>
                    </a>
                </div>
            </section>
</main>
